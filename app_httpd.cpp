...
extern unsigned long Timeout; //defined in main ESP32-cam-webserver file
...
static esp_err_t stream_handler(httpd_req_t *req){
    ...
    while(true){
        ...
        Timeout = millis(); //re arm the connection timeout to prevent ESP32 deepsleep while streaming
